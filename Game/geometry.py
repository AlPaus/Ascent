...
SCREEN_W = cfg.HEIGHT*1.8
SCREEN_H = cfg.WIDTH*1.8
EPSILON = 0.05
...
class Light:
    ...
    def add_obstacles(self, obstacles):
      self.walls = self.walls + self.obstacles_to_walls(obstacles)
      self.walls_centers = self.calculate_walls_centers()
      self.corners_open_walls: Dict = {}
      self.corners_close_walls: Dict = {}
      self.corners = self.find_corners()
    ...
    def new_obstacles(self, obstacles):
      self.walls = self.border_walls
